...
#include <string>
    ...
    bool Keybind(const char* label, const char* description, int* key)
    {
        ...
        GetWindowDrawList()->AddRectFilled(rect.Min, rect.Max, GetColorU32(ImStyle::elements::background, 0.5f), ImStyle::elements::rounding);

        window->DrawList->AddRectFilled(clickable.Min, clickable.Max, GetColorU32(ImStyle::elements::background + ImVec4(ImColor(10, 10, 10))), ImStyle::elements::rounding);

        RenderTextColor(lexend_reg, rect.Min + ImVec2(10, 0), rect.Max, GetColorU32(ImStyle::elements::text), description, ImVec2(0.0, 0.8));

        RenderTextColor(lexend_b, rect.Min + ImVec2(10, 0), rect.Max, GetColorU32(ImStyle::elements::text_active), label, ImVec2(0.0, 0.2));

        RenderTextColor(lexend_b, clickable.Min, clickable.Max, GetColorU32(ImStyle::elements::text_active), buf_display, ImVec2(0.5f, 0.5f));
    ...
    bool SliderScalar(const char* label, const char* description, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
    {
        ...
        const ImRect frame_bb(window->DC.CursorPos + ImVec2(180, 29), window->DC.CursorPos + ImVec2(w - 05, 41));
        ...
        GetWindowDrawList()->AddRectFilled(frame_bb.Min, frame_bb.Max, GetColorU32(ImStyle::elements::background_widget), 2.f);
        ...
        GetWindowDrawList()->AddRectFilled(frame_bb.Min, ImVec2(state.slow + (frame_bb.Min.x + 9), grab_bb.Max.y), GetColorU32(ImStyle::general_color), 2.f);

        char value_buf[64];
        const char* value_buf_end = value_buf + DataTypeFormatString(value_buf, IM_ARRAYSIZE(value_buf), data_type, p_data, format);

        RenderTextColor(lexend_b, rect.Min + ImVec2(10, 0), rect.Max, GetColorU32(ImStyle::elements::text_active), label, ImVec2(0.0, 0.2));
        RenderTextColor(lexend_b, rect.Min + ImVec2(0, 7), rect.Max - ImVec2(15, 10), GetColorU32(ImStyle::elements::text_active), value_buf, ImVec2(1.0, 0.0f));
    ...
    bool BeginCombo(const char* label, const char* description, const char* preview_value, int val, bool multi, ImGuiComboFlags flags)
    {
        ...
        state.text = ImLerp(state.text, state.opened_combo ? ImStyle::elements::text_active : hovered ? ImStyle::elements::text_hov : ImStyle::elements::text, g.IO.DeltaTime * 6.f);
        state.combo_size = ImLerp(state.combo_size, state.opened_combo ? (val * 33) + 17 : 0.f, g.IO.DeltaTime * 12.f);

        GetWindowDrawList()->AddRectFilled(bb.Min, bb.Max, GetColorU32(ImStyle::elements::background, 0.5f), ImStyle::elements::rounding);

        RenderTextColor(lexend_reg, bb.Min + ImVec2(10, 0), bb.Max, GetColorU32(ImStyle::elements::text), description, ImVec2(0.0, 0.8));

        //GetWindowDrawList()->AddRectFilled(bb.Min + ImVec2(w - 140, 0), bb.Max, GetColorU32(ImStyle::elements::background, 0.3f), ImStyle::elements::rounding);
        //GetWindowDrawList()->AddRectFilledMultiColor(bb.Min, bb.Max - ImVec2(120, 0), GetColorU32(ImStyle::general_color, 0.f), GetColorU32(ImStyle::general_color, 0.15f), GetColorU32(ImStyle::general_color, 0.15f), GetColorU32(ImStyle::general_color, 0.f), ImStyle::elements::rounding);

        GetWindowDrawList()->AddRectFilled(rect.Min, rect.Max, GetColorU32(ImStyle::elements::background_widget), ImStyle::elements::rounding);

        RenderTextColor(lexend_b, rect.Min + ImVec2(10, 0), rect.Max, GetColorU32(ImStyle::elements::text_active), preview_value, ImVec2(0.0, 0.5));
        GetWindowDrawList()->AddRectFilled(rect.Max - ImVec2(30, 30), rect.Max, GetColorU32(ImStyle::elements::background_widget), 2.f);

        GetWindowDrawList()->AddRectFilledMultiColor(rect.Min, rect.Max - ImVec2(30, 0), GetColorU32(ImStyle::elements::background_widget, 0.f), GetColorU32(ImStyle::elements::background_widget, 1.f), GetColorU32(ImStyle::elements::background_widget, 1.f), GetColorU32(ImStyle::elements::background_widget, 0.f), 2.f,0);

        RenderTextColor(icon_widget, rect.Min, rect.Max - ImVec2(7, 0), GetColorU32(ImStyle::general_color), "z", ImVec2(1.0, 0.5));
        RenderTextColor(lexend_b, bb.Min + ImVec2(10, 0), bb.Max, GetColorU32(ImStyle::elements::text_active), label, ImVec2(0.0, 0.2));

        GetWindowDrawList()->AddRectFilled(rect.Max - ImVec2(y_size, y_size), rect.Max, GetColorU32(state.background), ImStyle::elements::rounding);
        ...
        ImGui::SetNextWindowSize(ImVec2(32 + ImGui::CalcTextSize(preview_value).x, state.combo_size));
        ...
        PushStyleColor(ImGuiCol_WindowBg, ImStyle::elements::background);
        PushStyleColor(ImGuiCol_Border, ImStyle::elements::background_widget);
        PushStyleVar(ImGuiStyleVar_WindowRounding, ImStyle::elements::rounding);
    ...
    bool Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
    {
        ...
        if ((flags & ImGuiSelectableFlags_AllowItemOverlap) || (g.LastItemData.InFlags & ImGuiItemFlags_AllowOverlap)) { button_flags |= ImGuiButtonFlags_AllowItemOverlap; }
        ...
        state.text = ImLerp(state.text, selected ? ImStyle::general_color : ImStyle::elements::text, g.IO.DeltaTime * 6.f);
        state.opticaly = ImLerp(state.opticaly, selected ? 1.f : 0.f, g.IO.DeltaTime * 6.f);

        GetWindowDrawList()->AddRectFilled(bb.Min, bb.Max + ImVec2(0, 1), GetColorU32(ImStyle::elements::background_widget, state.opticaly), 2.f);

        RenderTextColor(lexend_b, text_min + ImVec2(1, 1), text_max, GetColorU32(state.text), label, ImVec2(0.f, 0.5f));
    ...
    bool RangeSliderBehavior(const ImRect& frame_bb, ImGuiID id, float* v1, float* v2, float v_min, float v_max, float power, int decimal_precision, ImGuiSliderFlags flags)
    {
        ...
        window->DrawList->AddRectFilled(frame_bb.Min, frame_bb.Max, GetColorU32(ImStyle::elements::background_widget), 30.f);
        ...
        window->DrawList->AddRectFilled(ImVec2(frame_bb.Min.x + state.slow1, frame_bb.Min.y), ImVec2(frame_bb.Min.x + state.slow2, frame_bb.Max.y), GetColorU32(ImStyle::general_color), 2.f);
    ...
    bool RangeSliderFloat(const char* label, const char* description, float* v1, float* v2, float v_min, float v_max, const char* display_format, float power)
    {
        ...
        state.text = ImLerp(state.text, IsItemActive() ? ImStyle::elements::text_active : hovered ? ImStyle::elements::text_hov : ImStyle::elements::text, g.IO.DeltaTime * 8.f);
        state.alpha_text = ImLerp(state.alpha_text, IsItemActive() ? 1.f : 0.f, g.IO.DeltaTime * 15.f);

        GetWindowDrawList()->AddRectFilled(rect.Min, rect.Max, GetColorU32(ImStyle::elements::background), ImStyle::elements::rounding);

        RenderTextColor(lexend_reg, rect.Min + ImVec2(10, 0), rect.Max, GetColorU32(ImStyle::elements::text), description, ImVec2(0.0, 0.8));

        GetWindowDrawList()->AddRectFilled(rect.Min + ImVec2(w - 140, 0), rect.Max, GetColorU32(ImStyle::elements::background), ImStyle::elements::rounding);
        GetWindowDrawList()->AddRectFilledMultiColor(rect.Min, rect.Max - ImVec2(120, 0), GetColorU32(ImStyle::elements::background, 0.f), GetColorU32(ImStyle::elements::background, 1.f), GetColorU32(ImStyle::elements::background, 1.f), GetColorU32(ImStyle::elements::background, 0.f), ImStyle::elements::rounding,0);
    ...
    bool QuandScalar(const char* label, const char* description, ImGuiDataType data_type, void* p_data0, void* p_data1, const void* p_min0, const void* p_max0, const void* p_min1, const void* p_max1, const char* format0, const char* format1, ImGuiSliderFlags flags)
    {
        ...
        GetWindowDrawList()->AddLine(ImVec2(it_anim->second.slow0 + frame_bb.Min.x, grab_bb0.Min.y), ImVec2(it_anim->second.slow0 + frame_bb.Min.x, grab_bb0.Max.y), GetColorU32(ImStyle::general_color), 0.5f);
        GetWindowDrawList()->AddShadowRect(ImVec2(it_anim->second.slow0 + frame_bb.Min.x, grab_bb0.Min.y), ImVec2(it_anim->second.slow0 + frame_bb.Min.x, grab_bb0.Max.y), GetColorU32(ImStyle::general_color, 0.5f), 25.f, ImVec2(0, 0), 100.f);

        GetWindowDrawList()->AddLine(ImVec2(grab_bb1.Min.x, it_anim->second.slow1 + frame_bb.Min.y), ImVec2(grab_bb1.Max.x, it_anim->second.slow1 + frame_bb.Min.y), GetColorU32(ImStyle::general_color), 0.5f);
        GetWindowDrawList()->AddShadowRect(ImVec2(grab_bb1.Min.x, it_anim->second.slow1 + frame_bb.Min.y), ImVec2(grab_bb1.Max.x, it_anim->second.slow1 + frame_bb.Min.y), GetColorU32(ImStyle::general_color, 0.5f), 25.f, ImVec2(0, 0), 100.f);

        GetWindowDrawList()->AddText(lexend_b, 17, ImVec2(rect.Min.x + 10, rect.Min.y + 10), GetColorU32(ImStyle::elements::text_active), label);

        std::string blah0(value_buf0), blah1(value_buf1);

        std::string label_x = "[X, " + blah0 + " Y, " + blah1 + "]";

        GetWindowDrawList()->AddText(lexend_b, 17, ImVec2(rect.Min.x + 10, rect.Min.y + 30), GetColorU32(ImStyle::elements::text), description);

        RenderTextColor(lexend_b, rect.Min + ImVec2(0, 7), rect.Max - ImVec2(15, 10), GetColorU32(ImStyle::elements::text_active), label_x.c_str(), ImVec2(1.0, 0.0f));
    ...
    bool icon_box(const char* icon, ImVec2 size, ImU32 color_bg, ImU32 color_icon, ImU32 color_border)
    {
        ...
        GetWindowDrawList()->AddRectFilled(rect.Min, rect.Max, GetColorU32(color_bg), ImStyle::elements::rounding);
        GetWindowDrawList()->AddRect(rect.Min, rect.Max, GetColorU32(color_border), ImStyle::elements::rounding);

        RenderTextColor(icon_widget, rect.Min, rect.Max, GetColorU32(color_icon), icon, ImVec2(0.5, 0.5));
    ...
    bool color_button(const char* name, ImVec2 size, ImU32 color_bg)
    {
        ...
        GetWindowDrawList()->AddCircle(rect.Min + ImVec2(size / 2), size.x / 3, GetColorU32(ImStyle::elements::background, 0.3f), 30.f, 3.f);
    ...
    bool ColorEdit4(const char* label, const char* description, float col[4], ImGuiColorEditFlags flags)
    {
        ...
        if (!(flags & ImGuiColorEditFlags_NoSmallPreview))
        {
            ...
            PushStyleColor(ImGuiCol_WindowBg, GetColorU32(ImStyle::elements::background));
            PushStyleColor(ImGuiCol_Border, GetColorU32(ImStyle::elements::background_widget));
            ...
            if (state.active)
            {
                SetNextWindowPos(g.LastItemData.Rect.GetTR() + ImVec2(-110, -200));

                Begin("picker", NULL, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoDecoration);
                {
                    ...
                    GetWindowDrawList()->AddText(lexend_b, 17.f, GetCursorScreenPos() - ImVec2(0, 2), GetColorU32(ImStyle::elements::text_active), (label != label_display_end && !(flags & ImGuiColorEditFlags_NoLabel)) ? label : "Color picker");

                    PushFont(icomoon_widget2);
                    ImGui::GetWindowDrawList()->AddText(GetCursorScreenPos() + ImVec2(GetContentRegionMax().x - (CalcTextSize("l").x + 15), 0), GetColorU32(ImStyle::elements::text_hov), "l");
                    PopFont();
                    ...
                    if (edited::icon_box("u", ImVec2(35, 35), GetColorU32(ImStyle::elements::background_widget), GetColorU32(ImStyle::general_color), GetColorU32(ImStyle::general_color, state.alpha_search)))
                    {
                        search_col = true;
                    };
                    ...
                    if (InputTextEx("v", "HEX COLOR", buf, IM_ARRAYSIZE(buf), ImVec2(!(flags & ImGuiColorEditFlags_NoAlpha) ? 128 : 118, 35), ImGuiInputTextFlags_CharsHexadecimal | ImGuiInputTextFlags_CharsUppercase, 0, 0))
                    {
                        value_changed = true;
                        char* p = buf;
                    ...
                    if (edited::icon_box(add_status ? "g" : "k", ImVec2(35, 35), GetColorU32(ImStyle::elements::background_widget), GetColorU32(ImStyle::general_color), GetColorU32(ImStyle::general_color, 0.f)))
                    {
        ...
        state.text = ImLerp(state.text, state.active ? ImStyle::elements::text_active : ImStyle::elements::text, g.IO.DeltaTime * 6.f);
        ...
        if (label != label_display_end && !(flags & ImGuiColorEditFlags_NoLabel))
        {
            ...
            RenderTextColor(lexend_reg, pos + ImVec2(10, 0), pos + ImVec2(GetContentRegionMax().x, 50), GetColorU32(ImStyle::elements::text), description, ImVec2(0.0, 0.8));
            RenderTextColor(lexend_b, pos + ImVec2(10, 0), pos + ImVec2(GetContentRegionMax().x, 50), GetColorU32(ImStyle::elements::text_active), label, ImVec2(0.0, 0.2));
    ...
    bool ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags, const float* ref_col)
    {
        ...
        draw_list->AddRectFilledMultiColor(picker_pos, picker_pos + ImVec2(sv_picker_size, sv_picker_size), col_white, hue_color32, hue_color32, col_white, 5.f,0);
        draw_list->AddRectFilledMultiColor(picker_pos - ImVec2(1, 1), picker_pos + ImVec2(sv_picker_size + 1, sv_picker_size + 1), 0, 0, col_black, col_black, 5.f,0);
        ...
        if (alpha_bar)
        {
            ...
            draw_list->AddRectFilledMultiColor(bar1_bb.Min, bar1_bb.Max, user_col32_striped_of_alpha, user_col32_striped_of_alpha, user_col32_striped_of_alpha & ~IM_COL32_A_MASK, user_col32_striped_of_alpha & ~IM_COL32_A_MASK, 100.f,0);
    ...
    bool ColorButton(const char* desc_id, const ImVec4& col, ImGuiColorEditFlags flags, const ImVec2& size_arg)
    {
        ...
        GetWindowDrawList()->AddRectFilled(clickable.Min, clickable.Max, GetColorU32(col_rgb), ImStyle::elements::rounding);

        RenderColorRectWithAlphaCheckerboard(window->DrawList, clickable.Min, clickable.Max, GetColorU32(col_rgb), ImMin(20, 20) / 2.99f, ImVec2(0.f, 0.f), ImStyle::elements::rounding);
    ...
    void esp_preview(ImTextureID player_preview, bool* nickname, float nick_color[4], bool* weapon, float weapon_color[4], int* hp, float hp_color[4], bool* zoom, float zoom_color[4], bool* bomb, float bomb_color[4], bool* c4, float c4_color[4], bool* money, float money_color[4], bool* hit, float hit_color[4], bool* esp_box, float box_color[4], bool* hp_line, float hp_line_color[4])
    {
        ...
        GetWindowDrawList()->AddImage(player_preview, player.Min, player.Max, ImVec2(0, 0), ImVec2(1, 1), GetColorU32(ImStyle::elements::text_active));

        static std::vector<std::string> partyNames = { "Nickname", "95%", "Zoomed", "Weapon", "Bomb", "50$", "HIT", "C4" };

        PushFont(lexend_reg);
        PushStyleColor(ImGuiCol_Text, GetColorU32(ImStyle::elements::text_active));
        ...
        if (*hp_line)  GetWindowDrawList()->AddLine(box.Min + ImVec2(-10, 0), box.Min + ImVec2(-10, 307), GetColorU32(ImStyle::elements::background_widget), 3.f);
        if (*hp_line)  GetWindowDrawList()->AddLine(box.Min + ImVec2(-10, 307 - hp_result), box.Min + ImVec2(-10, 307), GetColorU32(ImStyle::general_color), 3.f);
